...
export default function Totalavailableseemore() {
  return (
    <div>
    <div className="availableTitleSeemore"> <h2>Cars inventory </h2>
    <p> Cars listed here are not made available yet by the owner. You can still ask for permission</p></div>
